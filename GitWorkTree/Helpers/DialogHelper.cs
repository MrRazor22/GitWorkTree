...
namespace GitWorkTree.Helpers
{
    public static class DialogHelper
    {
        public static void ShowOperationError(IServiceProvider serviceProvider, string operationName, string errorMessage)
        {
            ...
            ShowMessageBoxInternal(serviceProvider, operationName, errorMessage);
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
        private static void ShowMessageBoxInternal(IServiceProvider serviceProvider, string operationName, string errorMessage)
        {
